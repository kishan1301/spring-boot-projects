...
public class MatchInputData {
	...
	public String toString() {
		return "MatchData [id=" + id + ", city=" + city + ", date=" + date + ", playerOfMatch=" + playerOfMatch
				+ ", venue=" + venue + ", neutralVenue=" + neutralVenue + ", team1=" + team1 + ", team2=" + team2
				+ ", tossWinner=" + tossWinner + ", tossDecision=" + tossDecision + ", winner=" + winner + ", result="
				+ result + ", resultMargin=" + resultMargin + ", eliminator=" + eliminator + ", method=" + method
